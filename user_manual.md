...
The user should first press Calibrate Skin, followed by the Calibrate Background, before start performing hand gestures to use selected features. **If the _Skin Mask_ doesn't clearly show only the hand of the user, please adjust the sliders in _Calibrate Values_.**
...
* Control playback or pause.
* Increase and Decrease Volume
* Minimise window.
* Move Window.
* Track mouse and perform mouse clicks.
