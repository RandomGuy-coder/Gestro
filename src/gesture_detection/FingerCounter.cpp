...
Mat FingerCounter::findFingersCount(Mat input_image, Mat frame) {
...
bool FingerCounter::isFinger(Point a, Point b, Point c, double limit_angle_inf, double limit_angle_sup, Point palm_center, double min_distance_from_palm) {
